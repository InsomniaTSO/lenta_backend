...
class ShopsSerializer(serializers.ModelSerializer): 
    """Сериализатор для объектов магазинов. Предоставляет подробную информацию о каждом магазине,
    включая id магазина, город, подразделение, формат, локацию, размер и статус активности. 
    """ 

    class Meta: 
        model = Shop 
        fields = ('store_id', 'city', 'division_code', 'type_format', 'type_loc_id', 'type_size_id', 'is_active')
