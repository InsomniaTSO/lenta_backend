...
class ForecastFilter(django_filters.FilterSet):
    ...
    """
    store = django_filters.AllValuesMultipleFilter(
    ...
    city = django_filters.AllValuesMultipleFilter(
        field_name='store__city__city_id'
    )
    ...
    is_active = django_filters.AllValuesMultipleFilter(
        field_name='store__is_active'
    )
    ...
    uom = django_filters.AllValuesMultipleFilter(
        field_name='product__uom'
    )
