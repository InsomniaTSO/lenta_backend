...
class ShopAPITests(APITestCase): 
    ...
    def setUp(self): 
        ...
        self.shop_1 = Shop.objects.create(store='store1', city=self.city_1, division=self.division_1, type_format=self.format_1, loc=self.location_1, size=self.size_1, is_active=1)
        self.shop_2 = Shop.objects.create(store='store2', city=self.city_2, division=self.division_2, type_format=self.format_2, loc=self.location_2, size=self.size_2, is_active=0)
