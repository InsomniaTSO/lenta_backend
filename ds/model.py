...
data_holidays = pd.read_csv(
    os.path.join(FILE_PATH, "holidays_covid_calendar.csv"), parse_dates=[4]
)
...
model = load_model(
    os.path.join(FILE_PATH, "lstm-model.h5"), custom_objects={"wape": wape}
)
